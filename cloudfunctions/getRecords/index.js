...
exports.main = async () => {
  ...
  await checkGuard(openid, "getRecords", 80, 5 * 60 * 1000, 30 * 60 * 1000);
  ...
  return {
    records: res.data.map((record) => ({
      ...
      reversedFileID: record.reversedFileID || "",
      originalTempUrl: record.originalTempUrl || "",
      reversedTempUrl: record.reversedTempUrl || "",
